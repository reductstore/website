...
| Name                         | Default | Description                                                                                                      |
| ---------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------- |
| `RS_AUDIT_ENABLED`           | false   | Enable or disable audit collection and persistence. When `false`, ReductStore skips audit writes.                |
...
- Audit is disabled by default (`RS_AUDIT_ENABLED=false`).
