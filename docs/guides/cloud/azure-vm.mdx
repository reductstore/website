...
{/* <head>
  <link
    rel="canonical"
    href="https://www.reduct.store/docs/guides/cloud/azure-vm"
  />
</head> */}
...
The following guide provides instructions on how to deploy ReductStore as a virtual machine on Azure using the Azure **[CLI](../../glossary#cli)** or Azure Portal.
...
Additionally, you can configure and provision ReductStore's resources in the same way. Read the **[Configuration](../../configuration.mdx)** page for more information.
...
After deploying ReductStore as a virtual machine, you can start storing and querying time-series data. Check our **[Guides](../index.mdx)** to learn more about the ReductStore features and how to use them.
