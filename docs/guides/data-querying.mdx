...
<Tabs>
  ...
  <TabItem value="Web Console">
    ...
    9. You will see the meta information about the records in the entry that match the time range. You can
...
<Tabs>
  ...
  <TabItem value="Web Console">
    ...
    8. Click the "Fetch Records" button to execute the query
    9. You will see the meta information about the records in the entry that match the condition. You can
       click on the download icon to download content of the record.
