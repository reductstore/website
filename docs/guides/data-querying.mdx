...
:::info
You can query records across multiple entries by providing the `entries` parameter with a list of entry names or patterns.
Exact entry names match as written.
