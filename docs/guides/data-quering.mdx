...
The `exclude` parameter is used to filter the records by the specified labels. The records that match ANY of the specified labels will be excluded from the result.
