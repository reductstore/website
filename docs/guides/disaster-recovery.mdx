...
For an end-to-end active-passive setup on cloud storage, see **[Cloud Storage Integration](../integrations/cloud-storage#active-passive-on-cloud-storage-s3-example)**.
...
For a full walkthrough using cloud storage, see **[Cloud Storage Integration](../integrations/cloud-storage#read-only-replica-on-cloud-storage-s3-example)**.
