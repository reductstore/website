...
<Tabs>
  ...
  <TabItem value="Web Console">
    Steps to remove a replication task using the Web Console:
      ...
      7. Confirm the deletion by typing the replication task name and clicking on the **Remove** button: ![Remove Replication Task Confirmation](./img/data_replication_remove_confirm.png)
