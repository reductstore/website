...
The remove query parameters are the same as the query parameters for the `query` method. Read more about the querying data in the [Querying Data](/docs/guides/querying-data#filter-paramaters) guide.
