...
<Tabs>
  ...
  <TabItem value="Web Console">
    ...
    ![Set bucket settings with Web Console](./img/buckets_create_settings.png)
...
<Tabs>
  ...
  <TabItem value="Web Console">
    ...
    ![Change bucket settings with Web Console](./img/buckets_change_settings.png)
...
<Tabs>
  ...
  <TabItem value="Web Console">
    ...
    ![Confirm bucket removal with Web Console](./img/buckets_remove_confirm.png)
