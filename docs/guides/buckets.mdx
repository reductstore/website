...
<Tabs>
    ...
    <TabItem value="Web Console">
        ...
        ![Create a bucket with Web Console](./img/buckets_create.png)
        5. In the **"Add a new bucket"** dialog, enter the bucket name and settings.
        6. Click on the "Create" button to create the bucket:<br/><img
        src={
            require("./img/buckets_create_settings.png").default
        }
        alt="Set bucket settings with Web Console"
        width="400"
    />
...
<Tabs>
    ...
    <TabItem value="Web Console">
        ...
        ![Browse bucket settings with Web Console](./img/buckets_browse_cog.png)
...
<Tabs>
    ...
    <TabItem value="Web Console">
        ...
        ![Browse a bucket with Web Console](./img/buckets_change_cog.png)
        7. Modify the settings as needed and click on the **Update** button:<br/><img
        src={
            require("./img/buckets_change_settings.png").default
        }
        alt="Change bucket settings with Web Console"
        width="400"
    />
...
<Tabs>
    ...
    <TabItem value="Web Console">
        ...
        ![Browse buckets with Web Console](./img/bucket_rename.png)
        6. Rename the bucket and click on the **Save** button:
        ![Remove a bucket with Web Console](./img/bucket_rename_save.png)
...
<Tabs>
    ...
    <TabItem value="Web Console">
        ...
        ![Remove a bucket with Web Console](./img/buckets_remove.png)
        7. Confirm the deletion by typing the bucket name and clicking on the **Remove** button:<br/><img
        src={
            require("./img/buckets_remove_confirm.png").default
        }
        alt="Confirm bucket removal with Web Console"
        width="400"
    />
