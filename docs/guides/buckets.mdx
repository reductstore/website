...
<Tabs>
  ...
  <TabItem value="Web Console">
    ...
    1. Open the Web Console by opening [http://127.0.0.1:8383](http://127.0.0.1:8383) in your browser.
...
<Tabs>
  ...
  <TabItem value="Web Console">
    ...
    ![Browse a bucket with Web Console](./img/buckets_browse_one.webp)

    6. You can see the bucket settings by clicking on the **Cog** icon in the bucket panel.
...
<Tabs>
  ...
  <TabItem value="Web Console">
    ...
    6. Open the bucket settings by clicking on the **Cog** icon in the bucket panel.
