...
&gt; `const` **DELETE**: [`LifecycleType`](../../../../type-aliases/LifecycleType.md) = `"delete"`

Defined in: [messages/LifecycleType.ts:10](https://github.com/reductstore/reduct-js/blob/main/src/messages/LifecycleType.ts#L10)
