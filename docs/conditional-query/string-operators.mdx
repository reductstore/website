...
|----------------|---------------------|---------------------------------------------|
| `$contains`    | v1.14               | Checks if a string contains a substring.    |
| `$starts_with` | v1.14               | Checks if a string starts with a substring. |
| `$ends_with`   | v1.14               | Checks if a string ends with a substring.   |
