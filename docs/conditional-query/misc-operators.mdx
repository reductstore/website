...
<head>
  <link
    rel="canonical"
    href="https://www.reduct.store/docs/conditional-query/misc-operators"
  />
</head>
...
The `$cast` operator is used to cast a [**label**](../glossary#label) value to a different type explicitly.
...
The `$ref` operator is used to reference a [**label**](../glossary#label) value in a [**record**](../glossary#record) explicitly.
