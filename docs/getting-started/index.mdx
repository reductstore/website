...
ReductStore is available as an Azure Virtual Machine on the [**Azure Marketplace**](https://azuremarketplace.microsoft.com/de-de/marketplace/apps/reductstorellc1689939980623.reductstore-server?tab=overview).
