...
- A valid license file for commercial usage, mounted into the container and configured via `RS_LICENSE_PATH` (see **[Configuration](../configuration/index.mdx#general-settings)** for details)
