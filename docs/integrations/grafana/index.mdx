...
For example, to extract only the `temperature` field from JSON records, you can use the [**ReductSelect Extension**](/docs/extensions/official/select-ext/overview) to specify the desired field:
