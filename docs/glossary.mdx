...
A label that wasn't assigned to a record during ingestion but is calculated by extensions. Computed labels are used for filtering and querying data, providing additional metadata for records.
