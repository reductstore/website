...
A user can use the `#ext` directive in the conditional query to activate the `ros` extension and define the parameters for extracting and transforming ROS data in the following format:
