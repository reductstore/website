...
| `iot` | MQTT/IIoT bundle. | **[MQTT](./input/mqtt/index.mdx)**, **[Shell](./input/shell/index.mdx)**, **[Metrics](./input/metrics/index.mdx)** | Snap: `reduct-bridge-iot`; Docker build type: `iot`; binary: `bridge-iot.x86_64-unknown-linux-gnu.tar.gz` |
