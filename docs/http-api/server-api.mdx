...
<head>
  <link rel="canonical" href="https://www.reduct.store/docs/http-api/server-api" />
</head>
...
<SwaggerComponent
  ...
  description={
    <>
      You can use this method to get stats of the storage, check its version and license. If authentication is enabled, the method needs a valid API token.
      <pre><code>
  ...
  responses={[
    ...
    },
    {
      ...
      summary: "If authentication is enabled and access token is invalid or empty"
    }
  ]}
/>
...
<SwaggerComponent
  ...
  description={
    <>
      You can use this method to browse the buckets of the storage. If authentication is enabled, the method needs a valid API token.
      <pre><code>
