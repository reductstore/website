  ...
  "replications": [
    {
      ...
      "mode": "string",             // replication mode: enabled, paused, or disabled
...
- v1.21: Added the `compression` field to compress replication batch transfers
  ...
  responses={[
    {
      ...
      description: (
        ...
        "settings": {
            ...
            "compression": "string",      // transfer compression: none (default), gzip, or zstd
            "include": {
            ...
            "mode": "string"              // replication mode: enabled (default), paused, or disabled
}`}</code>
        </pre>
      ),
    },
...
- v1.21: Added optional `compression` to compress replication batch transfers
  ...
  parameters={[
    ...
    },
    {
      ...
      details: {
        ...
        isRequired: false,
        description:
          'Transfer compression for replication batch payloads. Accepted values are "none", "gzip", and "zstd". Default is "none".',
      },
    },
    {
      type: "body",
    ...
    },
    {
      ...
      details: {
        ...
        isRequired: false,
        description:
          'Replication mode. Default is "enabled"; use "paused" to collect transactions without sending them or "disabled" to skip new transactions.',
      },
    },
  ]}
  responses={[
  ...
  parameters={[
    ...
    },
    {
      ...
      details: {
        ...
        isRequired: false,
        description:
          'Replication mode. Use "enabled" to send data, "paused" to accumulate transactions without sending them, or "disabled" to ignore new transactions.',
      },
    },
  ]}
  responses={[
...
<SwaggerComponent
  method="PATCH"
  path="/api/v1/replications/:replication_name/mode"
  summary="Update replication mode"
  parameters={[
    {
      type: "path",
      details: {
        name: "replication_name",
        isRequired: true,
        description: "Name of the replication to update",
      },
    },
    {
      type: "body",
      details: {
        ...
        isRequired: true,
        description:
          'New replication mode: "enabled" to send records, "paused" to store pending transactions without sending, or "disabled" to ignore new transactions.',
      },
    },
  ]}
  responses={[
    {
      status: "200",
      message: "OK",
      summary: "Replication mode was updated",
    },
    {
      status: "401",
      message: "Unauthorized",
