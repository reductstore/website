...
<head>
  <link rel="canonical" href="https://www.reduct.store/docs/http-api/bucket-api" />
</head>
...
For more information about buckets, read [**here**](../how-does-it-work.mdx#internal-structure).
...
<SwaggerComponent
  ...
  parameters={[
    ...
    },
    {
      ...
      details: {
        name: "quota_type",
        description: "Type of quota. Can have values 'NONE' or FIFO (default: NONE)",
        dataType: "String",
        isRequired: false,
      }
    },
