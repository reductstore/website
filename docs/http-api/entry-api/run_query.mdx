...
```typescript
{
    ...
    // Optional. If true, the query will be strict and return an error if any of the conditions cannot be evaluated
    // during query execution. If false or unset, the query will consider the incomplete condition to be false.
    strict?: "boolean"
