...
:::info
This section describes the batch format used by the Entry API batch endpoints (`/api/v1/b/:bucket_name/:entry_name/batch`). For batched I/O across multiple entries, use the [**I/O API**](./io-api) and Batch Protocol v2.
:::
...
On the server side you can control the parameters of batching by using the **[I/O Settings](../../configuration/settings.mdx#io-settings)**.
