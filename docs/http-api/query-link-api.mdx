...
Since version 1.17.0, ReductStore supports **Query Links** - a secure way to share data without access tokens. The Query Link API provides HTTP methods for creating and downloading query links.
The query links can be created with specific permissions and expiration times, allowing for controlled access to the data.
...
<SwaggerComponent
    ...
    "link": "string" // The generated query link
        ...
        },
        {
            status: "403",
            message: "Forbidden",
            summary: "Current access token doesn't have enough permissions to read the bucket",
        }
    ]}
/>
...
```json5
{
    "expires_at": "string", // Expiration date of the link in ISO 8601 format (UTC)
...
<SwaggerComponent
    ...
    queryParams={[
        ...
        },
        {
            ...
            type: "string",
            isRequired: false,
            description: "Record number in the query result to download. If not provided, the first record matching the query will be returned."
        }
    ]}
    responses={[
        {
        ...
        },
        {
            ...
            message: "Not Found",
            summary:
                "The queried bucket or entry does not exist",
        },
        {
            status: "422",
