...
const landingFaqs = [
  {
    ...
    answer:
      <>
        <p>
          ReductStore is built for scalability, designed to efficiently manage large data volumes typical in edge computing and AI/ML workflows.
          It combines blob and time-series data functionalities, enabling the system to handle billions of time-stamped blobs. Scaling up primarily involves expanding disk capacity.
          The system's architecture supports low-latency access with iterator and range query capabilities, ensuring optimal performance at scale.
          More information about the architecture can be found in the <strong><Link to="/docs/how-does-it-work">How Does It Work</Link></strong> section of the documentation.
        </p>
      </>,
  },
  {
    question: "Are there any customization options for data retention and replication policies?",
    answer:
      <>
        <p>
