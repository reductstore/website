...
We built our engine from scratch to handle massive, real-time, unstructured data at the edge — and now we’re looking for a **Senior Software Engineer** to help us push the boundaries of performance, reliability, and simplicity.
...
- Write high-quality, maintainable code (mainly in **Rust** and **Python**)
