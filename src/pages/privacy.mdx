...
To enhance our Service, we gather information through your browser or app when you use our Service. This includes non-personal details like device type, browser type, and the referring URL.

**Matomo Analytics:**

We employ [**Matomo**](https://matomo.org/), a privacy-centric analytics tool, to gain insights into how our Service is utilized. Matomo enables the collection of site usage data in a way that preserves user privacy. 
This data is used to improve our Service and provide a better user experience.

**Your Privacy Choices:**

We only use cookies with your explicit consent and for specific purposes.

For full control over your data:

- **Manage Your Preferences:** You can adjust your cookie and analytics settings at any time. Simply click on "Manage Preferences" to customize your settings.
<button type="button" data-cc="show-preferencesModal" className="button button--xs button--secondary">Manage Preferences</button>

- **Complete Opt-Out:** Our service uses cookie-less tracking for an anonymous browsing experience, but if you prefer to opt out of all analytics, select the option below for complete privacy. <MatomoOptOut />

Opting out or customizing settings is specific to each browser and device. You'll need to repeat these steps as necessary.
