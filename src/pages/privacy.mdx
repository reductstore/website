...
import DoNotSell from "@site/src/components/shared/DoNotSell";
...
For analytical insights, we utilize [**Google Analytics**](https://analytics.google.com/), which assists us in gathering data on how our Service is interacted with. This information aids us in improving our Service and crafting a better user experience for you.

**Cookie Consent Management**

We use [**CookieYes**](https://www.cookieyes.com/) for cookie consent management. You can manage your cookie preferences at any time by visiting our [**Cookie Policy**](/cookies) or clicking the cookie consent button on our website.
...
### 3. Payment and Subscription Usage Data

We use [**Stripe**](https://stripe.com/) as our payment processor for ReductPro subscriptions. Stripe receives the billing contact details and payment method details that you provide during checkout, as well as the subscription and payment information needed to process payments and manage the subscription.

For ReductPro subscriptions, the license server receives the peak storage in GB and the Stripe customer ID from the database to calculate subscription usage and associate that usage with the subscription.
...
In our dedication to understanding user interactions, we employ Google Analytics for website analytics. We use CookieYes for cookie consent management, ensuring that analytics cookies are only deployed with your explicit consent.

Our use of cookies allows for a more nuanced analysis of website usage patterns, contributing to our understanding of user interactions and preferences. We ensure that the use of cookies is transparent and gives you control over your data, with options to manage your preferences via our [**Cookie Policy**](/cookies).
...
In compliance with US state privacy laws, we provide the following option to allow users to opt out of the sale or sharing of their personal data. To exercise this right, please use the link below.
