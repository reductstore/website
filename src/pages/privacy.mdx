...
For ReductPro subscriptions, the license server collects the peak storage in GB and the Stripe customer ID from the database to calculate subscription usage and associate that usage with the subscription.
