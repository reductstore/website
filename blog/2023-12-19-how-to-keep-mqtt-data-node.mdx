...
ReductStore provides many client SDKs to integrate it in your infrastructure. In this example we will use the client SDK for [JavaScript](https://github.com/reductstore/reduct-js). 
