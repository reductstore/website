...
description: ReductStore v1.13.0 is now available with a new conditional query API that allows use logical and comparison operators to filter records by labels when quering or removing.authors: alexey
tags: [news]
