...
Than, simply install the required libraries for our example using pip:
...
The replication task can be set using client libraries, HTTP API, provisioning, or the ReductStore web console.
