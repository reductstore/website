...
For an end-to-end walkthrough (including S3-based standalone, active-passive, and replicas), see the **[S3 Backend](/docs/1.18.x/integrations/s3)** tutorial. For architecture options and operational notes, see the **[Disaster Recovery](/docs/guides/disaster-recovery)** guide.
