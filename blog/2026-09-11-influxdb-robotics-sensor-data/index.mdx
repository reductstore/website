...
date: 2026-09-11
image: ./img/influxdb-reductstore-robotics-architecture.svg
---

![Robotics sensor data architecture showing metrics flowing to InfluxDB and raw camera, LiDAR, and waveform data flowing to ReductStore](./img/influxdb-reductstore-robotics-architecture.svg)
