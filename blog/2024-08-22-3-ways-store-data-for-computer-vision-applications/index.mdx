...
- **Labeling.**  We can label data and use these labels as [**annotations**](/docs/guides/data-ingestion#annotating-data) and [**search criteria**](/docs/guides/data-replication).
