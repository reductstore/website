...
If you're interested in details, you can read about the [**`GET /api/v1/b/:bucket/:entry/batch` endpoint**](/docs/http-api/entry-api). However, if you use one of our client SDKs, you just need to update to the latest version without making any changes to your code.
