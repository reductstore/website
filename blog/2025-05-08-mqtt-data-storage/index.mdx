---
title: "Four MQTT Database Types for Sensor, Image and Log Data"
description: "Which MQTT database holds sensor readings, images and log files? Time series, NoSQL, blob and relational stores compared on speed, scale and cost."
authors: anthony
...
| High frequency sensor, MQTT payload, or camera data   | Time-indexed object storage | ReductStore                                                |
...
If you are interested in learning more about storing data for computer vision applications, you can check out our tutorial [**3 Ways to Store Data for Computer Vision Applications**](/blog/computer-vision-applications).
