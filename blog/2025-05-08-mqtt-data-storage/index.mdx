...
- **ReductStore**: a high-performance storage and streaming tool for unstructured time-series data. It stores blobs with timestamps, making it ideal for MQTT payloads like images, audio, vibration data or logs.
