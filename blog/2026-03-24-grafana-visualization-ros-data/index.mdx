...
In this tutorial, we will create a Grafana dashboard supported by the **[ReductStore data source plugin](/docs/integrations/grafana)**.
...
You can read more about the query format in the **[ReductROS documentation](/docs/next/extensions/official/ros-ext/raw#query-format)**.
...
## пше Optional: Visualize binary topics (images)
