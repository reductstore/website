...
<ThemedImage
  alt="Architecture for Air-Gapped Drone Data Operations"
  sources={{
    light: require("./img/architecture-drone-light.drawio.svg").default,
    dark: require("./img/architecture-drone-dark.drawio.svg").default,
  }}
/>
