...
- [**Drone-to-Ground Architecture**](#drone-to-ground-architecture)
- [**Setting Up the Drone Node**](#setting-up-the-drone-node)
...
services:
  reductstore:
    ...
    volumes:
      user: "0:0" # Run as root with host bind mount in this example
      - ./data:/data
```
...
- **[Conditional Query Reference](/docs/conditional-query)** for all available conditional query operators you can use in replication filters and queries
