...
INSAION's engineers wrote up the whole mechanism, from MCAP slicing to the S3 upload pipeline, in their [**edge recording deep dive**](https://www.insaion.com/blog/reductstore-edge-recording).
