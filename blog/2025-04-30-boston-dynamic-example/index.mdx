---
title: "How to work with ROS bag files and classify robot movements using Python"
description: "Learn how to process .bag files and train models to classify different robot movements"
authors: ekaterina
