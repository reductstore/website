...
#### [Output files](https://docs.tangramvision.com/metrical/results/output_file)

Each calibration generates a set of output files located in the `$PATH/metrical/examples/camera_lidar` directory.

- **results.json**

  This main output file contains key calibration data, including:
  ...
  - **Optimized object space features**
  
  - [**Residual metrics**](https://docs.tangramvision.com/metrical/results/residual_metrics/circle_misalignment)

- **detections.json**
  
  Stores all feature detections used during calibration

- **report.html**

  Calibration Report with visual overview of results.
