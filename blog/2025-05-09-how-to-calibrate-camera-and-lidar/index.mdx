...
- [**Flexible data input:**](https://docs.tangramvision.com/metrical/input_data/data_formats) Supports ROSbags, MCAP files (highly recommended), and folder-based datasets (only until July 2025)
...
- **Broad target support:** Works with a range of 2D and 3D [**targets**](https://docs.tangramvision.com/metrical/first_steps/choosing_targets), with [**premade targets**](https://gitlab.com/tangram-vision/platform/metrical_premade_targets)(recommended); support [**multiple targets**](https://docs.tangramvision.com/metrical/core_concepts/object_space/multiple_fiducials) at once
...
- **report.html:** A calibration report with visual overview of resultsю
