...
<small style={{ display: 'block', marginTop: '-20px' }}>
  Photo by Jan Antonin Kolar on <a href="https://unsplash.com/photos/lRoX0shwjUQ?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText" target="_blank" rel="noopener noreferrer">Unsplash</a>
</small>
