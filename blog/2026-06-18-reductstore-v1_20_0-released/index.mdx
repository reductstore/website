...
If you add compression policies, test them first with `dry_run` mode and review diagnostics in `$system/lifecycle` before enabling automatic compression in production.
