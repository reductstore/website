---
title: "Open Source Foxglove Alternatives: RViz and Rerun"
description: "Foxglove is proprietary with a free tier. RViz and Rerun are open source, BSD and MIT. Compare licensing, pricing and the viewer UI of all three."
authors: ekaterina
...
None of these tools decide where the data lives. RViz, Foxglove and Rerun all read from a bag file or a live topic, so a long recording still needs somewhere to sit that can be queried by time range. That is the job [**ReductStore**](/) does alongside them: time-indexed buckets, replication by label, and retention by size quota instead of by hand.
...
We hope this comparison helps you make informed decisions and inspires you to keep exploring better tools and workflows. If you have questions, feedback, or insights to share, join the conversation on the [**ReductStore Community Forum**](https://community.reduct.store).
