...
Now, we need to install the [**Reduct Client SDK for C++**](https://github.com/reductstore/reduct-cpp). Please refer to [**these instructions**](/docs/getting-started/with-cpp).
