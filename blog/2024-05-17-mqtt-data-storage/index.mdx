...
| High frequency sensor, images, or blob data | Time-series object store  | [**ReductStore**](/)                                                                                  |
| Large volumes of unstructured or semi-structured data | NoSQL                                             | MongoDB, Amazon DynamoDB, Apache Cassandra                                                   |
| Large amounts of blob data (multimedia files)       | Blob Storage                                      | MinIO, Azure Blob Storage, Google Cloud Storage, Amazon S3                                   |
