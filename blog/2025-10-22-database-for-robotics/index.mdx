---
title: "A Database for Robotics: Store and Manage Data from Robot to Cloud"
...
<BridgeDiagram
  ...
  className="bridgeArchitectureDiagram"
  style={{
    maxWidth: "440px",
    width: "100%",
    height: "auto",
...
On top of that stored data, INSAION adds fleet dashboards, per device inventory and access control, synchronized replay of camera, LiDAR, TF, and logs, and AI diagnostics.
