...
[INSAION](https://www.insaion.com) is a robotics observability platform built on top of ReductStore. Its agent embeds ReductStore on the robot to record every topic locally, then syncs only the time windows an alarm asks for to the cloud. On that data it layers fleet dashboards, per device inventory, synchronized replay of camera, LiDAR, and logs, and AI diagnostics.

Read more in our [ReductStore and INSAION partnership](/blog/news/reductstore-insaion-partnership) announcement.
