...
This guide will help you get started with the [**ReductStore C++ SDK**](https://github.com/reductstore/reduct-cpp) to integrate ReductStore into your application.
...
in [**our Guides**](/docs/guides). You can also
refer to the [**ReductStore HTTP API**](/docs/http-api) documentation for a complete reference
