---
title: ReductStore v1.17.0 Released with Shared Links and S3 Storage Backend Support
...
ReductStore now supports **shared links**, enabling users to generate temporary, public URLs for specific data records — without requiring authentication.
...
You can create shared links directly from the **Web Console**:

1. Open the **Data Browser** page and select one or more records you want to share.
...
Once generated, anyone with the link can access the data via a simple HTTP request — no login required.
This feature provides a secure and convenient way to expose selected data for collaboration and analysis.
