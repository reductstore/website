...
1. **Google Account:** To use Colab, you need a Google account. If you use Gmail, you already have one. If not, you can [**create a Google account**](https://colab.research.google.com/).

2. **Hugging Face Account:** LeRobot uses models and datasets hosted on Hugging Face. To access them, you'll need to [**create a Hugging Face account**](https://huggingface.co/).
