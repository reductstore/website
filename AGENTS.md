...
- For optional security controls that are disabled by default (for example, rate limits), document both facts explicitly and add operator guidance for exposed or multi-tenant deployments.
