...
- Version 1.18: deleting an entire entry (no `ts`) is non-blocking; cleanup continues in the background.
        ...
        [
            ...
            },
            {
                ...
                message:
                    "Conflict",
                summary:
                    "The bucket is being deleted or the entry is being deleted",
            },
            {
                status: "422",
                message:
