---
title: Querying Directives
description: Learn how to use querying directives in conditional queries to modify the behavior of data retrieval in
---

<head>
  <link
    rel="canonical"
    href="https://www.reduct.store/docs/conditional-query/directives/querying"
  />
</head>

The querying directives are special instructions in **[conditional queries](../../glossary#conditional-query)** that modify how the query engine retrieves and returns data.
