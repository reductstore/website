...
This directive overrides the server's `RS_IO_BATCH_MAX_SIZE` setting. See the [**server configuration documentation**](../../configuration/settings.mdx#io-settings) for more details.
...
This directive overrides the server's `RS_IO_BATCH_MAX_RECORDS` setting. See the [**server configuration documentation**](../../configuration/settings.mdx#io-settings) for more details.
...
This directive overrides the server's `RS_IO_BATCH_MAX_METADATA_SIZE` setting. See the [**server configuration documentation**](../../configuration/settings.mdx#io-settings) for more details.
...
This directive overrides the server's `RS_IO_BATCH_TIMEOUT` setting. See the [**server configuration documentation**](../../configuration/settings.mdx#io-settings) for more details.
...
This directive overrides the server's `RS_IO_BATCH_RECORD_TIMEOUT` setting. See the [**server configuration documentation**](../../configuration/settings.mdx#io-settings) for more details.
