...
<InstallSdk>
    To install the ReductStore **[SDK](../glossary#sdk)**, you will need to have Python 3.8 or higher installed on your machine. Once Python is
...
<CreateBucketSection>
    To create a **[bucket](../glossary#bucket)**, you should use the `create_bucket` method on a `Client` instance. Pass the name of the bucket
