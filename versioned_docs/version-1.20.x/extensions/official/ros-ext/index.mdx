...
| --------------------------------- | ------------------------------ | ----------------------------------------------------------------------------- |
| **[Raw Messages](./ros-ext/raw)** | Raw ROS1/ROS2/Protobuf records | Extract ROS1/ROS2/Protobuf messages as JSON or export them as MCAP.           |
| **[MCAP](./ros-ext/mcap)**        | MCAP files                     | Extract ROS1/ROS2/Protobuf messages as JSON or create filtered MCAP episodes. |
