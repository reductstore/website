...
<SwaggerComponent
    ...
    responses={[
        ...
        },
        {
            status: "403",
            message: "Forbidden",
            summary: "Access token does not have the required permissions to access the resource",
        },
        {
            status: "409",
            message: "Conflict",
        ...
        },
        {
            status: "404",
            message: "Not Found",
            summary: "The bucket or record with the specified timestamp does not exist.",
        },
        {
            status: "422",
...
<SwaggerComponent
    ...
    responses={[
        ...
        },
        {
            status: "403",
            message: "Forbidden",
            summary: "Access token doesn't have the required permissions to access this resource",
        },
        {
            status: "409",
            message: "Conflict",
        ...
        },
        {
            status: "404",
            message: "Not Found",
            summary: "The bucket or record with the specified timestamp doesn't exist",
        },
        {
            status: "422",
            message: "Unprocessable Entity",
