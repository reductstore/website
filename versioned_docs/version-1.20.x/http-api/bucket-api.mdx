...
- Version 1.18: bucket and entry responses include the `status` field (`READY` / `DELETING`).
...
- Version 1.18: deletion is non-blocking; cleanup continues in the background.
...
<SwaggerComponent
  ...
  responses={[
    ...
    },
    {
      status: "409",
      message: "Conflict",
      summary: "Bucket is provisioned or being deleted",
    },
    {
      status: "429",
      message: "Too Many Requests",
