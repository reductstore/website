...
|              | to bool                         | to int              | to float                | to string             | to duration             |
| ------------ | ------------------------------- | ------------------- | ----------------------- | --------------------- | ----------------------- |
| **bool**     | -                               | true → 1, false → 0 | true → 1.0, false → 0.0 | "true", "false"       | true → 1us, false → 0us |
| **int**      | 0 → false, other → true         | -                   | cast to float           | string representation | value in us             |
| **float**    | 0.0 → false, other → true       | cast to int         | -                       | string representation | value in us             |
| **string**   | non-empty → true, empty → false | parse as int        | parse as float          | -                     | parse as duration       |
| **duration** | 0us → false, other → true       | cast to int (in us) | cast to float (in us)   | string representation | -                       |
