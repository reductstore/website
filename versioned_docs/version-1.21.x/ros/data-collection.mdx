...
<head>
  <link
    rel="canonical"
    href="https://www.reduct.store/docs/ros/data-collection"
  />
</head>
...
time-indexed ReductStore records. The example preserves payloads serialized
using the **[Common Data Representation (CDR)](../glossary.mdx#cdr)** format and
their ROS schemas, assigns timestamps and labels, and writes the records to a
...
**[bridge.toml example](https://github.com/reductstore/website/blob/main/docs/ros/example/bridge.toml)**:
