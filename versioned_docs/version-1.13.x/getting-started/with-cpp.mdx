...
<DataQueryingSection>
    ...
    provide a `when` condition to filter records based on labels. Read more about the query syntax in the [**Conditional Query Reference**](/docs/conditional-query/index.mdx).
